...
# initialize our Flask application and the models
...
def predict():
	...
	if flask.request.method == "POST":
		...
		logger.info(f'{dt} Data: title={title}, text={text}, subject={subject}')
		try:
...
# if this is the main thread of execution first load the models and
